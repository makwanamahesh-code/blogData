            ...
            2 == postnumber
                ? "page" == type
                    ...
                    : '<span class="pagenumber"><a href="/search/label/' +
                      ...
                      "</a></span>"
                : "page" == type
                ? '<span class="pagenumber"><a href="#" aria-label="Previous Page" rel="prev" onclick="redirectpage(' +
                  s +
                  ');return false">' +
                  prevpage +
                  "</a></span>"
                : '<span class="pagenumber"><a href="#" aria-label="Previous Page" rel="prev" onclick="redirectlabel(' +
                  s +
                  ');return false">' +
                  prevpage +
                  "</a></span>");
    ...
    postnumber < maximum &&
        (e +=
            "page" == type
                ? '<span class="pagenumber"><a href="#" onclick="redirectpage(' +
                  n +
                  ');return false" aria-label="Next Page" rel="next">' +
                  nextpage +
                  "</a></span>"
                : '<span class="pagenumber"><a href="#" onclick="redirectlabel(' +
                  n +
...
function appendScriptToHead(src, callback) {
